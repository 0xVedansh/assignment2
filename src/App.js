  ...
  useEffect(() => {
    ...
    const fetchTabContent = async () => {
      ...
      const tabContentData = [
        { title: 'TOMMY', content: 'Full Stack Web Developer', time: 'December 2015 - Present' },
        { title: 'BIGDROP', content: 'Front-End Engineer', time: 'May 2015 - December 2015' },
        { title: 'CUKER', content: 'Engineering Intern', time: 'May 2014 - September 2015' },
      ];
    ...
    <div className="page-container">
      <div className="tabs-container">
        ...
        <div className="tab-content">
          {tabContent.length > 0 && (
            <>
              <p className="text-edit">{tabContent[selectedTab].content}</p>
              <p><span className="text-edit1">{tabContent[selectedTab].title}</span></p>
              <p>{tabContent[selectedTab].time}</p>
